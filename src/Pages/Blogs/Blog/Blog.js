...
const Blog = () => {
    return (
        <div style={{ minHeight: '100vh' }}>
            ...
            <div className='pt-4 bg-light text-center'>
                <h3 className='fs-5 fw-bold text-muted text-uppercase'>Programing <span className='fw-bold fs-1 text-success'>Q/A</span> </h3>
                <div style={{ height: '1px' }} className='bg-dark w-50 d-block mx-auto'></div>
                <h2 className='text-center text-uppercase fs-5 my-5'><span style={{ color: 'white', borderRadius: '50px', border: '2px solid #003366', backgroundColor: '#003366' }} className='py-2 px-5'>Atafal Blog</span></h2>
            </div>
