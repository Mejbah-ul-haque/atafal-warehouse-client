...
const Special1 = () => {
    return (
        <div className='container mt-5'>
            <p style={{ backgroundColor: '#e2e2e2', marginTop: '70px' }} className='w-100 d-block mx-auto'><span style={{ color: 'white', borderRadius: '10px' }} className='btn fw-bold d-block mx-auto mt-4 mb-3 px-5 text-dark text-uppercase'>Extra Section one</span></p>
