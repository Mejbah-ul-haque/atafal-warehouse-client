        ...
        <div className="col">
            <div className="card text-center">
                ...
                <div className="">
                    ...
                    <div className="px-3">
                        <h2 className='fw-bold fs-6 text-center text-uppercase'>{name.slice(18)}</h2>
                        ...
                        <p className='text-center mt-2 pb-0'><button onClick={() => navigateToInventory(_id)} style={{ backgroundColor: '', color: 'goldenrod' }} className='btn btn-dark rounded-0 px-5 py-1'>Update</button></p>
                    </div>
                </div>
            </div>
        </div>
